...
from page_locators.bot_detect_captcha_locators.bot_detect_captcha_base_page_locator import BotDetectCaptchaBasePageLocator


class BotDetectCaptchaDemoLocator(BotDetectCaptchaBasePageLocator):
	"""
